...
void begin_script_call(Entity *e)
{
  ...
  globals(e->script->lua)["whoseCharacterIsThisBall"] = e->whoseCharacterIsThisBall;
}
...
void end_script_call(Entity *e)
{
  ...
  e->whoseCharacterIsThisBall = luabind::object_cast<int>(globals(e->script->lua)["whoseCharacterIsThisBall"]);
